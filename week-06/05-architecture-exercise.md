...
Draw the Day 11 private-report workflow. Day 12 components will be added after
the Day 12 class.
...
Use arrows labeled `uploads`, `CopyObject`, `GenerateDataKey / Decrypt`, and
`presigned GET`. Use a red denied path for anonymous access.
